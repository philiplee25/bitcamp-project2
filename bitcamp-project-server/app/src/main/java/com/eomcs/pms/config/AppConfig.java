...
public class AppConfig {
  ...
  // 그리고 이 메서드의 리턴 값을 컨테이너에 보관해두라고 요구해야 한다.
  ...
  public SqlSessionFactory sqlSessionFactory(DataSource dataSource, // DB 커넥션풀
    ...
    sqlSessionFactoryBean
        .setMapperLocations(appCtx.getResources("classpath:com/eomcs/pms/mapper/*Mapper.xml"));
