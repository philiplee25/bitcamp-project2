...
public class ProjectListHandler extends HttpServlet {
  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      } else if ((title != null && title.length() > 0) || (owner != null && owner.length() > 0)
      ...
      for (Project p : projects) {
        ...
        out.printf(
            ...
            p.getNo(), p.getTitle(), p.getStartDate(), p.getEndDate(), p.getOwner().getName(),
            strBuilder.toString());
      }
      out.println("</tbody>");
      out.println("</table>");
      ...
      out.printf(
          ...
          title != null ? title : "");
      out.printf(
          "  <tr> <th>관리자</th>" + " <td><input type='search' name='owner' value='%s'></td> </tr>\n",
          owner != null ? owner : "");
      out.printf(
          "  <tr> <th>팀원</th>" + " <td><input type='search' name='member' value='%s'></td> </tr>\n",
          member != null ? member : "");
